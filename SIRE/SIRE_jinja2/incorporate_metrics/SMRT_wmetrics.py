...
#    print header
    ...
    if metrics:
        ...
        for v in metrics_data:
            ...
            for h in metrics_header:
                if h == 'Scaffolds':
                    break
                datum.append(s[h])
            datum += [s['scaffolds'], s['scaffold_length'], s['scaffold_N50'],
        ...
        if metrics_table_data and js_metrics_header and simplified_data:
            ...
            all_results.append(datum)
    env = Environment(loader=FileSystemLoader('/home/analysis/ctc/dev/SMRT/SMRT_jinja2'), lstrip_blocks=True, trim_blocks=True)
