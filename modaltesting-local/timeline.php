				...
				<div class="row timeline">
					...
					<div class="col-sm-4">
							...
							<div class="modal fade" id="deliverymodal" tabindex="-1" role="dialog" aria-labelledby="deliverymodal">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
											<h4 class="modal-title" id="deliverymodal">Start</h4>
										</div>
										<div class="modal-body">
											<!-- start delivery form -->
											<form method="post" id="deliver1">
												<div class="form-group">
													<label for="ddm">Delivery Date Meeting</label>
						...
						<div id="delivery">
							<ul>
								<li>Delivery Date Meeting:	</li>
								<li>Collaborator Notified:	</li>
								<li>Downstream Analyst:	</li>
								<li>Notes:	</li>
					...
					<div class="col-sm-4">
							...
							<div class="modal fade" id="closemodal" tabindex="-1" role="dialog" aria-labelledby="closemodal">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
											<h4 class="modal-title" id="closemodal">Start</h4>
										</div>
										<div class="modal-body">
											<!-- start close form -->
						...
						<div id="close"> 
							<ul>
								<li>Close Date:	</li>
								<li>Results in Archive:	</li>
								<li>Location of Results:	</li>
