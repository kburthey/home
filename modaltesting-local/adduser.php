<?php 
	...
	if (array_key_exists("submit", $_POST)) {
		...
		if (!$_POST['targetdelivery']) {
			$error .= "Please select a targe delivery date";
		}		
		if ($error != "") {
				...
				<form method="post" id="login">
					<div class="form-group login">
						<label for="windowsId" class="control-label">Windows ID</label>
						  ...
						  <input type="email" name="windowsId" class="form-control" id="windowsId" placeholder="windowsId">
						
					  </div>
					  <div class="form-group login">
						<label for="password3" class="control-label">Password</label>
						
						  <input type="password" name="password3" class="form-control" id="password3" placeholder="Password">
