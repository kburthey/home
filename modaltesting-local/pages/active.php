		...
		if ($error != "") {
			$error = "<p> There were error(s) in your form: </p>".$error;
				...
				if (mysqli_num_rows($result) > 0 ) {
					...
					$query = "insert into studies (name, description) values ('".mysqli_real_escape_string($link, $_POST['name'])."', '".mysqli_real_escape_string($link, $_POST['description'])."')";
	...
	<body>
		...
		<div class="menu">
			<div class="container">
				<div class="nav">
					<ul>
						<li><a href="modalindex.html">Home</a></li>
						<li><a href="#myModalstudy" data-toggle="modal" data-backdrop="static">New Study</a></li>
										...
										<div class="modal-body">
											<form method="post">
												<div class="form-group">
													<label for="exampleInputEmail1">Study Name</label>
													<input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="">
												</div>
												<div class="form-group">
													<label for="exampleInputPassword1">Study Description</label>
												...
												<button><input type="submit" name="submit" class="btn btn-primary" value="Save Changes"></button>
											</form>
										</div>
							...
							<!-- End Modal -->
						<li><a href="pages/closed.html">Reports</a></li>
						<li><a href="">BINS Users</a></li>
					</ul>
				</div>
			</div>
		</div>
		<div class="main">
			<div class="container">
				...
				<div class="panel panel-default">
					<div class="panel-body" data-toggle="modal" data-target="#myModal" data-backdrop="static">
						Study #1 Example<br>
						Details
					</div>
					<div class="progress">
				...
				<div class="modal fade" tabindex="-1" role="dialog" id="myModal">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
								<h4 class="modal-title">Study #1 Summary</h4>
							</div>
							<div class="modal-body">
				...
				<div class="panel panel-default">
					<div class="panel-body" data-toggle="modal" data-target="#myModal2" data-backdrop="static">
						Study #2 Example<br>
						Details
					</div>
					<div class="progress">
				...
				<div class="modal fade" tabindex="-1" role="dialog" id="myModal2">
					<div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
								<h4 class="modal-title">Study #2 Summary</h4>
							</div>
							<div class="modal-body">
								<p>Work In Progress&hellip;</p>
							</div>
				...
				<div class="panel panel-default">
					<div class="panel-body" data-toggle="modal" data-target="#myModal3" data-backdrop="static">
						Study #3 Example<br>
						Details
					</div>
					<div class="progress">
				...
				<div class="modal fade" tabindex="-1" role="dialog" id="myModal3">
					<div class="modal-dialog modal-sm" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
								<h4 class="modal-title">Study #3 Summary</h4>
							</div>
							<div class="modal-body">
								<p>Work In Progress&hellip;</p>
							</div>
				...
				<div class="panel panel-default">
					<div class="panel-body" data-toggle="modal" data-target="#myModal4" data-backdrop="static">
						Study #4 Example<br>
						Details
					</div>
					<div class="progress">
				...
				<div class="modal" tabindex="-1" role="dialog" id="myModal4">
					<div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
								<h4 class="modal-title">Study #4 Summary</h4>
							</div>
							<div class="modal-body">
								<p>Work In Progress&hellip;</p>
							</div>
					...
					<!-- Panel -->
				<div class="panel panel-default">
					<div class="panel-body" data-toggle="modal" data-target="#myModal5" data-backdrop="static">
						Study #5 Example<br>
						Details
					</div>
					<div class="progress">
				...
				<div class="modal fade" tabindex="-1" role="dialog" id="myModal5">
					<div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
								<h4 class="modal-title">Study #5 Summary</h4>
							</div>
							<div class="modal-body">
								<p>Work In Progress&hellip;</p>
								<br>
					...
					<!-- Panel -->
				<div class="panel panel-default">
					<div class="panel-body" data-toggle="modal" data-target="#myModal6" data-backdrop="static">
						Study #6 Example<br>
						Details
					</div>
					<div class="progress">
				...
				<div class="modal fade" tabindex="-1" role="dialog" id="myModal6">
					<div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
								<h4 class="modal-title">Study #6 Summary</h4>
							</div>
							<div class="modal-body">
								<p>Work In Progress&hellip;</p>
								<br>
