				...
				<div class="row timeline">
					<div class="col-sm-4">
						...
						<h3><a href="#startmodal" data-toggle="modal" data-backdrop="static" id="starttitle">Start</a></h3>
						...
						<?php
							...
							if(isset($_GET['study'])) {
								...
								if (mysqli_connect_error()) {
									...
									echo<<<EOT
							<ul>
								<li>Start Date: <span class="studydetails"> {$row['startdate']}</span></li>
								<li>Analyst: <span class="studydetails"> {$row['primaryanalyst']}</span></li>
								<li>SoW:<span class="studydetails"> {$row['SoW']}</span>	</li>
...
EOT;
	...
	?>
					...
					<div class="col-sm-4">
						...
						<h3><a href="#deliverymodal" data-toggle="modal" data-backdrop="static" id="deliverytitle">Delivery</a></h3>
						...
						<?php
							...
							if(isset($_GET['study'])) {
								...
								if (mysqli_connect_error()) {
									...
									echo<<<EOT
							<ul>
								<li>Delivery Date Meeting: <span class="studydetails"> {$row['deliverymeeting']} </span>	</li>
								<li>Collaborator Notified:<span class="studydetails"> {$row['collabnotified']}</span>	</li>
								<li>Downstream Analyst:<span class="studydetails"> {$row['downstream']}	</span></li>
...
EOT;
	...
	?>
					...
					<div class="col-sm-4">
						...
						<h3><a href="#closemodal" data-toggle="modal" data-backdrop="static" id="closetitle">Close</a></h3>
						...
						<?php
							...
							<ul>
								...
								<li>Results in Archive:<span class="studydetails"> {$row['resultarchive']}</span>	</li>
								<li>Location of Results:<span class="studydetails"> <a id="locationlink" href="http://demeter.nafta.syngenta.org{$row['resultlocation']}" target="_blank"> {$row['resultlocation']}</a></span></li>
